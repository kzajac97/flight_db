...
./yugabyte/bin/ysqlsh -h -q yb-tserver-n1-europe -c "\c flight_db" -c "\i flight_db/scripts/sql/populate/airlines.sql"
./yugabyte/bin/ysqlsh -h -q yb-tserver-n1-europe -c "\c flight_db" -c "\i flight_db/scripts/sql/populate/airports.sql"
./yugabyte/bin/ysqlsh -h -q yb-tserver-n1-europe -c "\c flight_db" -c "\i flight_db/scripts/sql/populate/routes.sql"
./yugabyte/bin/ysqlsh -h -q yb-tserver-n1-europe -c "\c flight_db" -c "\i flight_db/scripts/sql/populate/flights.sql"